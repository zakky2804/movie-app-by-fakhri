...
export default function LoadingMovieDetail() {
  return (
    <>
      <div
        className="animate-pulse min-h-[678px] mb-8  sm:min-h-screen md:min-h-[711px] md:mb-8 xl:mb-0"
        aria-hidden="true"
      >
        <div className="pt-32 pb-20 px-6 sm:px-16 flex gap-x-10 xl:min-w-7xl max-w-[1351px] ">
          ...
          <div className="w-full xl:max-w-[700px] pt-8 xl:pt-8 lg:max-w-[536px]">
            ...
            <div className="mt-5 md:mt-6">
              <div className="h-6 w-[72px] bg-secondary rounded-xl mb-4 sm:mb-[19px] md:mb-[13px] xl:mb-[10px]" />
